...
const Navmenu = ({ menus, userRole }) => {
  ...
  const filteredMenus = menus.filter((item) => {
    if (item.roles) {
      // If a menu item has a "roles" property, check if the userRole is included
      return item.roles.includes(userRole);
    }
    return true; // Show the item if no role restriction is defined
  });
